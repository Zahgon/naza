...
func NewLeakyBucket(intervalMs int) *LeakyBucket { _ = "STUB: not implemented"; return nil }

// 注意，第一次获取资源，需要与创建对象时的时间点做比较

// 尝试获取资源，获取成功返回nil，获取失败返回ErrResourceNotAvailable
// 如果获取失败，上层可自由选择多久后重试或丢弃本次任务
func (lb *LeakyBucket) TryAquire() error { _ = "STUB: not implemented"; return nil }

// 距离上次获取成功时间超过了间隔阈值，返回成功

// 阻塞直到获取到资源
func (lb *LeakyBucket) WaitUntilAquire() { _ = "STUB: not implemented"; return }
...
func (lb *LeakyBucket) MaybeAvailableIntervalMs() int64 { _ = "STUB: not implemented"; return 0 }
